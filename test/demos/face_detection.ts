...
//        let cascade_cpu = new alvision.CascadeClassifier();
//        let cascade_gpu = new alvision.CascadeClassifier_GPU();
...
//                const detections_num = cascade_gpu.detectMultiScale(gray_gpu, facesBuf_gpu, 1.2, 4);
