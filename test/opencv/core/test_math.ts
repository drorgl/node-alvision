...
//                    b.at<alvision.float>("float", i, 0).set(Math.abs(alvision.cubeRoot(a.at<alvision.float>("float", i, 0).get()).valueOf()));
//                    for (var j = 1; j < a.cols; j++)
//                        b.at<alvision.float>("float", i, j).set(Math.abs(alvision.cubeRoot(a.at<alvision.float>("float", i, j).get()).valueOf()));
//                }
//            }
//            else
...
//                    {
//                        let a_data = a.ptr<alvision.uchar>("uchar");
//                        let b_data = b.ptr<alvision.uchar>("uchar");
//                        if (ipower < 0)
//                            for (j = 0; j < ncols; j++) {
//                                let val = a_data[j];
...
//                    {
//                        let a_data = a.ptr<alvision.schar>("schar");
//                        let b_data = b.ptr<alvision.schar>("schar");
//                        if (ipower < 0)
//                            for (j = 0; j < ncols; j++) {
//                                let val = a_data[j];
...
//                    {
//                        let a_data = a.ptr<alvision.ushort>("ushort");
//                        let b_data = b.ptr<alvision.ushort>("ushort");
//                        if (ipower < 0)
//                            for (j = 0; j < ncols; j++) {
//                                var val = a_data[j];
...
//    run_func(): void {
//        this.test_mat[this.OUTPUT][0].at<alvision.Scalar>("Scalar", 0, 0).set(alvision.trace(this.test_array[this.INPUT][0]));
//    }

//    prepare_to_validation(test_case_idx: alvision.int): void {
//        var mat = this.test_mat[this.INPUT][0];
//        var count = Math.min(mat.rows.valueOf(), mat.cols.valueOf());
//        var diag = new alvision.Mat(count, 1, mat.type(), mat.ptr<alvision.uchar>("uchar"), mat.step.valueOf() + mat.elemSize().valueOf());
//        var r = alvision.cvtest.mean(diag);
//        r = alvision.Scalar.op_Multiplication(r, count);

//        this.test_mat[this.REF_OUTPUT][0].at<alvision.Scalar>("Scalar", 0, 0).set(r);
//    }
//};
...
//    }
//    run_func(): void {
//        this.test_mat[this.OUTPUT][0].at<alvision.Scalar>("Scalar", 0, 0).set(new alvision.Scalar(this.test_array[this.INPUT][0].dot(this.test_array[this.INPUT][1])));//cvDotProduct(test_array[INPUT][0], test_array[INPUT][1]))
//    }
//    prepare_to_validation(test_case_idx: alvision.int): void {
//        this.test_mat[this.REF_OUTPUT][0].at<alvision.Scalar>("Scalar", 0, 0).set(new alvision.Scalar(alvision.cvtest.crossCorr(this.test_mat[this.INPUT][0], this.test_mat[this.INPUT][1])));
//    }
...
//        a.val[0] = ((<alvision.Mat>(this.test_array[this.INPUT][0])).at<alvision.double>("double", 0, 0)).get();
//        a.val[1] = ((<alvision.Mat>(this.test_array[this.INPUT][0])).at<alvision.double>("double", 1, 0)).get();
//        a.val[2] = ((<alvision.Mat>(this.test_array[this.INPUT][0])).at<alvision.double>("double", 2, 0)).get();

//        b.val[0] = ((<alvision.Mat>(this.test_array[this.INPUT][1])).at<alvision.double>("double", 0, 0)).get();
//        b.val[1] = ((<alvision.Mat>(this.test_array[this.INPUT][1])).at<alvision.double>("double", 1, 0)).get();
//        b.val[2] = ((<alvision.Mat>(this.test_array[this.INPUT][1])).at<alvision.double>("double", 2, 0)).get();
//    }
//    else if (this.test_mat[this.INPUT][0].cols > 1) {
//        a.val[0] = ((<alvision.Mat>(this.test_array[this.INPUT][0])).at<alvision.double>("double", 0)).get();
//        a.val[1] = ((<alvision.Mat>(this.test_array[this.INPUT][0])).at<alvision.double>("double", 1)).get();
//        a.val[2] = ((<alvision.Mat>(this.test_array[this.INPUT][0])).at<alvision.double>("double", 2)).get();

//        b.val[0] = ((<alvision.Mat>(this.test_array[this.INPUT][1])).at<alvision.double>("double", 0)).get();
//        b.val[1] = ((<alvision.Mat>(this.test_array[this.INPUT][1])).at<alvision.double>("double", 1)).get();
//        b.val[2] = ((<alvision.Mat>(this.test_array[this.INPUT][1])).at<alvision.double>("double", 2)).get();
//    }
//    else {
//        a = new alvision.Scalar(((<alvision.Mat>(this.test_array[this.INPUT][0])).at<alvision.double>("double", 0)).get());
//        b =new alvision.Scalar( ((<alvision.Mat>(this.test_array[this.INPUT][1])).at<alvision.double>("double", 0)).get());
//    }

//    c.val[2] =  a.val[0].valueOf() * b.val[1].valueOf() - a.val[1].valueOf() * b.val[0].valueOf();
//    c.val[1] = -a.val[0].valueOf() * b.val[2].valueOf() + a.val[2].valueOf() * b.val[0].valueOf();
//    c.val[0] =  a.val[1].valueOf() * b.val[2].valueOf() - a.val[2].valueOf() * b.val[1].valueOf();

//    if (this.test_mat[this.REF_OUTPUT][0].rows > 1) {
//        ((<alvision.Mat>(this.test_array[this.REF_OUTPUT][0])).at<alvision.double>("double", 0, 0)).set(c.val[0]);
//        ((<alvision.Mat>(this.test_array[this.REF_OUTPUT][0])).at<alvision.double>("double", 1, 0)).set( c.val[1]);
//        ((<alvision.Mat>(this.test_array[this.REF_OUTPUT][0])).at<alvision.double>("double", 2, 0)).set( c.val[2]);
//    }
//    else if (this.test_mat[this.REF_OUTPUT][0].cols > 1) {
//        ((<alvision.Mat>(this.test_array[this.REF_OUTPUT][0])).at<alvision.double>("double", 0)).set( c.val[0]);
//        ((<alvision.Mat>(this.test_array[this.REF_OUTPUT][0])).at<alvision.double>("double", 1)).set( c.val[1]);
//        ((<alvision.Mat>(this.test_array[this.REF_OUTPUT][0])).at<alvision.double>("double", 2)).set( c.val[2]);
//    }
//    else {
//        (<alvision.Mat>(this.test_array[this.REF_OUTPUT][0])).at<alvision.Scalar>("Scalar", 0).set( c);
//    }
//}
//};
...
//    if (mat_depth == alvision.MatrixType.CV_32F )
//    {
...
//    else
//    {
//        assert(mat_depth == alvision.MatrixType.CV_64F );
//        for( var i = 0; i < transmat.rows; i++ )
//            for( j = 0; j < cols; j++ )
...
//        if (CV_MAT_DEPTH(types[this.INPUT][0]) == alvision.MatrixType.CV_32S)
//            types[this.INPUT][0] = (types[INPUT][0] & ~CV_MAT_DEPTH_MASK) | alvision.MatrixType.CV_32F;
...
//        CV_MAT_DEPTH(types[INPUT][0]) == alvision.MatrixType.CV_64F || (bits & 512) ? alvision.MatrixType.CV_64F : alvision.MatrixType.CV_32F;
...
//    }
//            prepare_to_validation(test_case_idx  : alvision.int ) : void{
//    let avg = this.test_mat[this.REF_INPUT_OUTPUT][0];
//    let scale = 1.;
...
//        t_flag ^ ((flags & CV_COVAR_NORMAL) != 0) ? alvision.GemmFlags.GEMM_1_T : alvision.GemmFlags.GEMM_B_T);
//    temp_hdrs.clear();
//    }
...
//    CV_Assert(type == alvision.MatrixType.CV_32FC1 || type == alvision.MatrixType.CV_64FC1 );
...
//    }
//    get_success_error_level(test_case_idx: alvision.int, i: alvision.int, j: alvision.int): alvision.double {
//        return CV_MAT_DEPTH(cvGetElemType(test_array[INPUT][0])) == alvision.MatrixType.CV_32F ? 1e-2 : 1e-5;
//    }
//    void get_minmax_bounds(i : alvision.int, j: alvision.int, type : alvision.int,  low : alvision.Scalar, high : alvision.Scalar){

//    low = alvision.Scalar.all(-2.);
//    high = alvision.Scalar.all(2.);
//}
//    int prepare_test_case(int test_case_idx ){
//    int code = Core_MatrixTest::prepare_test_case(test_case_idx);
//    if (code > 0)
//        cvTsFloodWithZeros(test_mat[INPUT][0], this.ts.get_rng());
...
//    double t, det = 1.;
//    assert(CV_MAT_TYPE(a.type) == alvision.MatrixType.CV_64FC1 &&
//           (!b || CV_ARE_TYPES_EQ(a,b)) && (!x || CV_ARE_TYPES_EQ(a,x)));

//    for( i = 0; i < Nm; i++ )
//    {
//        double max_val = Math.abs(a0[i*step + i]);
//        double *a1, *a2, *b1 = 0, *b2 = 0;
//        k = i;

//        for( j = i+1; j < N; j++ )
//        {
//            t = Math.abs(a0[j*step + i]);
//            if( max_val < t )
//            {
//                max_val = t;
//                k = j;
...
//    if ((bits & 3) == 0) {
//        method = alvision.DecompTypes.DECOMP_SVD;
//        if (bits & 4) {
...
//    types[TEMP][1] = alvision.MatrixType.CV_64FC1;
//    sizes[OUTPUT][0] = sizes[REF_OUTPUT][0] = Size(min_size, min_size);
//}
//    void get_minmax_bounds(i : alvision.int, j: alvision.int, type : alvision.int,  low : alvision.Scalar, high : alvision.Scalar){
//    low = alvision.Scalar.all(-1.);
//    high = alvision.Scalar.all(1.);
//}
//    get_success_error_level(test_case_idx : alvision.int, i : alvision.int, j  : alvision.int) : alvision.double {
...
//                Mat(), 0., test_mat[TEMP][0], alvision.GemmFlags.GEMM_B_T);
...
//    double threshold = (input.depth() == alvision.MatrixType.CV_32F ? alvision.FLT_EPSILON : alvision.DBL_EPSILON) * 1000;

//    alvision.cvtest.convert(input, temp1, temp1.type());

//    if (det < threshold ||
//        ((method == CV_LU || method == CV_CHOLESKY) && (result == 0 || ratio < threshold)) ||
//        ((method == alvision.DecompTypes.DECOMP_SVD || method == CV_SVD_SYM) && result < threshold)) {
...
//    alvision.setIdentity(dst0, Scalar.all(1));
//    }
//    int method, rank;
//    double result;
//};
...
//        for( i = 0; i < nm; i++ )
//            det *= w.data.fl[i];
//        *ratio = w.data.fl[nm-1] < alvision.FLT_EPSILON ? 0 : w.data.fl[nm-1]/w.data.fl[0];
//    }
//    else
//    {
//        for( i = 0; i < nm; i++ )
//            det *= w.data.db[i];
//        *ratio = w.data.db[nm-1] < alvision.FLT_EPSILON ? 0 : w.data.db[nm-1]/w.data.db[0];
//    }
...
//        int bits = alvision.cvtest.randInt(rng);
//        Base::get_test_array_types_and_sizes(test_case_idx, sizes, types);
//        alvision.Size in_sz = sizes[INPUT][0];
//        if (in_sz.width > in_sz.height)
//            in_sz = alvision.Size(in_sz.height, in_sz.width);
//        Base::get_test_array_types_and_sizes(test_case_idx, sizes, types);
//        sizes[INPUT][0] = in_sz;
//        int min_size = MIN(sizes[INPUT][0].width, sizes[INPUT][0].height);
...
//     0, 0., test_array[TEMP][0], alvision.GemmFlags.GEMM_B_T );
...
//        double threshold = (input.type() == alvision.MatrixType.CV_32F ? alvision.FLT_EPSILON : alvision.DBL_EPSILON) * 1000;
//        CvMat _input = input;
//        double ratio = 0, det = cvTsSVDet( &_input, &ratio);
...
//    if (pdst != &dst)
//        alvision.cvtest.gemm(input, *pdst, 1., Mat(), 0., dst, alvision.GemmFlags.GEMM_1_T);
//    dst0 = alvision.Scalar.all(0);
//    }
...
//void Core_SVDTest::get_test_array_types_and_sizes( int test_case_idx, Array<Array<Size> >& sizes, Array<Array<int> >& types )
//{
//    var rng = this.ts.get_rng();
//    int bits = alvision.cvtest.randInt(rng);
...
//    flags = bits & (alvision.SVDFlags.MODIFY_A+alvision.SVDFlags.NO_UV+alvision.SVDFlags.FULL_UV);
//    have_u = (bits & 8) != 0;
//    have_v = (bits & 16) != 0;
//    symmetric = (bits & 32) != 0;
//    compact = (bits & 64) != 0;
...
//        if( flags & alvision.SVDFlags.NO_UV )
...
//        if( !(flags & alvision.SVDFlags.FULL_UV) )
...
//    types[OUTPUT][3] = alvision.MatrixType.CV_8UC1;
...
//            alvision.cvtest.gemm( input, input, 1., Mat(), 0., temp, alvision.GemmFlags.GEMM_B_T );
//            alvision.cvtest.copy( temp, input );
//        }

//        if( (flags & alvision.SVDFlags.MODIFY_A) && test_array[OUTPUT][0] )
...
//    double input_precision = input_depth < alvision.MatrixType.CV_32F ? 0 : input_depth == alvision.MatrixType.CV_32F ? 1e-5 : 5e-11;
...
//{
//    CvArr* src = test_array[!(flags & alvision.SVDFlags.MODIFY_A) ? INPUT : OUTPUT][0];
//    if( !src )
...
//    int i, m = input.rows, n = input.cols, min_size = Math.min(m, n);
//    Mat *src, *dst, *w;
//    double prev = 0, threshold = depth == alvision.MatrixType.CV_32F ? alvision.FLT_EPSILON : alvision.DBL_EPSILON;

//    if( have_u )
//    {
//        src = &test_mat[TEMP][1];
//        dst = &test_mat[OUTPUT][1];
//        alvision.cvtest.gemm( *src, *src, 1., Mat(), 0., *dst, src.rows == dst.rows ? alvision.GemmFlags.GEMM_B_T : alvision.GemmFlags.GEMM_1_T );
//        alvision.setIdentity( test_mat[REF_OUTPUT][1], alvision.Scalar.all(1.) );
//    }
...
//        alvision.cvtest.gemm( *src, *src, 1., Mat(), 0., *dst, src.rows == dst.rows ? alvision.GemmFlags.GEMM_B_T : alvision.GemmFlags.GEMM_1_T );
//        alvision.setIdentity( test_mat[REF_OUTPUT][2], alvision.Scalar.all(1.) );
//    }
...
//            aii = depth == alvision.MatrixType.CV_32F ? w.at<float>(i,i) : w.at<double>(i,i);
//        }
//        else
//        {
//            normval = aii = depth == alvision.MatrixType.CV_32F ? w.at<float>(i) : w.at<double>(i);
//        }

//        normval = Math.abs(normval - aii);
...
//            for( i = 0; i < min_size; i++ )
//            {
//                double val = depth == alvision.MatrixType.CV_32F ? w.at<float>(i) : w.at<double>(i);
...
//                     flags & alvision.SVDFlags.NO_UV ? alvision.GemmFlags.GEMM_1_T : 0 );
//            alvision.cvtest.gemm( test_mat[REF_OUTPUT][0], test_mat[TEMP][2], 1., Mat(), 0.,
//                     test_mat[OUTPUT][0], flags & alvision.SVDFlags.FULL_UV ? 0 : alvision.GemmFlags.GEMM_B_T );
//        }
//        else
//        {
//            alvision.cvtest.gemm( *w, test_mat[TEMP][2], 1., Mat(), 0., test_mat[REF_OUTPUT][0],
//                     flags & alvision.SVDFlags.FULL_UV ? 0 : alvision.GemmFlags.GEMM_B_T );
//            alvision.cvtest.gemm( test_mat[TEMP][1], test_mat[REF_OUTPUT][0], 1., Mat(), 0.,
//                     test_mat[OUTPUT][0], flags & alvision.SVDFlags.NO_UV ? alvision.GemmFlags.GEMM_1_T : 0 );
//        }
...
//void Core_SVBkSbTest::get_test_array_types_and_sizes( int test_case_idx, Array<Array<Size> >& sizes,
...
//    bool is_float = input.type() == alvision.MatrixType.CV_32F;
...
//    if( is_float )
//    {
//        test_mat[TEMP][1].convertTo(u, alvision.MatrixType.CV_64F);
//        test_mat[TEMP][2].convertTo(v, alvision.MatrixType.CV_64F);
//        if( !b.empty() )
//            test_mat[INPUT][1].convertTo(b, alvision.MatrixType.CV_64F);
//    }

//    Mat t0, t1;

//    if( !b.empty() )
//        alvision.cvtest.gemm( u, b, 1., Mat(), 0., t0, !(flags & alvision.SVDFlags.NO_UV) ? alvision.GemmFlags.GEMM_1_T : 0 );
//    else if( flags & alvision.SVDFlags.NO_UV )
...
//    alvision.cvtest.gemm( v, t1, 1, Mat(), 0, t0, flags & alvision.SVDFlags.FULL_UV ? alvision.GemmFlags.GEMM_1_T : 0 );
//    Mat& dst0 = test_mat[REF_OUTPUT][0];
...
//    {
//        return Math.abs(lhs.real() - rhs.real()) > Math.abs(rhs.real())*FLT_EPSILON ? lhs.real() < rhs.real() : lhs.imag() < rhs.imag();
//    }
//};
...
//        Array<complex_type> r(n), ar(n), c(n + 1, 0);
//        Array<double> a(n + 1), u(n * 2), ar1(n), ar2(n);

//        int rr_odds = 3; // odds that we get a real root
//        for (int j = 0; j < n;)
//        {
//            if (alvision.cvtest.randInt(rng) % rr_odds == 0 || j == n - 1)
//                r[j++] = alvision.cvtest.randReal(rng).valueOf() * range;
//            else
//            {
//                r[j] = complex_type(alvision.cvtest.randReal(rng).valueOf() * range,
//                                    alvision.cvtest.randReal(rng).valueOf() * range + 1);
//                r[j + 1] = std::conj(r[j]);
//                j += 2;
//            }
//        }
...
//            CvMat amat, umat;
//            cvInitMatHeader(&amat, n + 1, 1, alvision.MatrixType.CV_64FC1, &a[0]);
...
//            {
//                ar2.resize(n);
//                alvision.Mat _umat2(3, 1, alvision.MatrixType.CV_64F, &ar2[0]), umat2 = _umat2;
//                cvFlip(&amat, &amat, 0);
//                int nr2;
//                if( cubic_case == 0 )
//                    nr2 = alvision.solveCubic(alvision.cvarrToMat(&amat),umat2);
//                else
//                    nr2 = alvision.solveCubic(alvision.Mat_<float>(alvision.cvarrToMat(&amat)), umat2);
//                cvFlip(&amat, &amat, 0);
//                if(nr2 > 0)
...
//                int nr1 = 0;
//                for(int j = 0; j < n; j++)
//                    if( Math.abs(r[j].imag()) < DBL_EPSILON )
//                        ar1[nr1++] = r[j].real();
...
//            for (int j = 0; j < n; ++j)
//            {
//                s += Math.abs(r[j].real()) + Math.abs(r[j].imag());
...
//                ts.printf( alvision.cvtest.TSConstants.LOG, "ar2[%d]=%g\n", j, ar2[j]);
//            ts.printf(alvision.cvtest.TSConstants.LOG, "\n");

//            for (size_t j=0;j<r.size();++j)
//                ts.printf( alvision.cvtest.TSConstants.LOG, "r[%d]=(%g, %g)\n", j, r[j].real(), r[j].imag());
//            ts.printf( alvision.cvtest.TSConstants.LOG, "\n" );
//            for (size_t j=0;j<ar.size();++j)
//                ts.printf( alvision.cvtest.TSConstants.LOG, "ar[%d]=(%g, %g)\n", j, ar[j].real(), ar[j].imag());
//            break;
//        }
//    }
//}
...
//    {
//        const  maxAngleDiff = 0.5; //in degrees
//        const axisCount = 8;
//        const dim =   alvision.theRNG().uniform(1,10);
//        const scale = alvision.theRNG().uniform(1., 100.);
//        Mat x(axisCount + 1, dim, alvision.MatrixType.CV_32FC1),
//            y(axisCount + 1, dim, alvision.MatrixType.CV_32FC1);
//        Mat anglesInDegrees(axisCount + 1, dim, alvision.MatrixType.CV_32FC1);
...
//{
//    alvision.Mat m;
//    ASSERT_TRUE( alvision.checkRange(m) );
//}
...
//{
//    alvision.Mat m(3, 3, alvision.MatrixType.CV_32SC1, alvision.Scalar(INT_MAX));
//    ASSERT_FALSE( alvision.checkRange(m, true, 0, 0, INT_MAX) );
//    ASSERT_TRUE( alvision.checkRange(m) );
//}
...
//    alvision.Mat src = alvision.Mat(3,3, alvision.DataDepth<TypeParam>::value, data);

//    alvision.Point bad_pt(0, 0);
...
//    alvision.Mat src1 = alvision.Mat.zeros(3, 3, alvision.DataDepth<TypeParam>::value);

//    int sizes[] = {5, 6, 7};
//    alvision.Mat src2 = alvision.Mat.zeros(3, sizes, alvision.DataDepth<TypeParam>::value);
...
//    alvision.Mat src1 = alvision.Mat.ones(3, 3, alvision.DataDepth<TypeParam>::value);

//    int sizes[] = {5, 6, 7};
//    alvision.Mat src2 = alvision.Mat.ones(3, sizes, alvision.DataDepth<TypeParam>::value);
...
//{
//    alvision.Mat a = (alvision.Mat_<float>(3,3) << 2.42104644730331, 1.81444796521479, -3.98072565304758, 0, 7.08389214348967e-3, 5.55326770986007e-3, 0,0, 7.44556154284261e-3);
//    //alvision.randu(a, -1, 1);

//    alvision.Mat b = a.t()*a;
//    alvision.Mat c, i = Mat_<float>::eye(3, 3);
//    alvision.invert(b, c, alvision.DECOMP_LU); //console.log(b*c << std::endl;
//    ASSERT_LT( alvision.cvtest.norm(b*c, i, CV_C), 0.1 );
//    alvision.invert(b, c, alvision.DECOMP_SVD); //console.log(b*c << std::endl;
//    ASSERT_LT( alvision.cvtest.norm(b*c, i, CV_C), 0.1 );
//    alvision.invert(b, c, alvision.DECOMP_CHOLESKY); //console.log(b*c << std::endl;
//    ASSERT_LT( alvision.cvtest.norm(b*c, i, CV_C), 0.1 );
//});
...
//                    Array<alvision.Point2f> data0(N0);
//                    rng.fill(data0, alvision.DistType.UNIFORM, -1, 1);

//                    Array<alvision.Point2f> data(N);
//                    for( i = 0; i < N; i++ )
//                        data[i] = data0[rng.uniform(0, N0)];

//                    kmeans(data, K, labels, TermCriteria(alvision.TermCriteriaType.MAX_ITER+alvision.TermCriteriaType.EPS, 30, 0),
//                           5, KMEANS_PP_CENTERS);
//                }
//                else
//                {
//                    Mat data0(N0, dims, alvision.MatrixType.CV_32F);
//                    rng.fill(data0, alvision.DistType.UNIFORM, -1, 1);
...
//                    {
//                    case MAT_N_DIM_C1:
//                            data.create(N, dims, alvision.MatrixType.CV_32F);
//                        for( i = 0; i < N; i++ )
...
//                            data.create(N, dims + 5, alvision.MatrixType.CV_32F);
...
//                            data.create(N, 3, alvision.MatrixType.CV_32FC(dims));
...
//                Mat hist(K, 1, alvision.MatrixType.CV_32S, Scalar(0));
//                for( i = 0; i < N; i++ )
//                {
...
//    alvision.Mat src(vector_size, col_problem_size * row_problem_size, alvision.MatrixType.CV_32F);
//    int singleMatFlags = CV_COVAR_ROWS;

//    alvision.Mat gold;
//    alvision.Mat goldMean;
//    alvision.randu(src,alvision.Scalar(-128), alvision.Scalar(128));
//    alvision.calcCovarMatrix(src, gold, goldMean, singleMatFlags, alvision.MatrixType.CV_32F);
//    Array<alvision.Mat> srcVec;
...
//    alvision.Mat actual;
//    alvision.Mat actualMean;
//    alvision.calcCovarMatrix(srcVec, actual, actualMean, singleMatFlags, alvision.MatrixType.CV_32F);

//    alvision.Mat diff;
//    alvision.absdiff(gold, actual, diff);
//    alvision.Scalar s = alvision.sum(diff);
//    ASSERT_EQ(s.dot(s), 0.0);

//    alvision.Mat meanDiff;
//    alvision.absdiff(goldMean, actualMean.reshape(0,1), meanDiff);
//    alvision.Scalar sDiff = alvision.sum(meanDiff);
...
//    alvision.reduce(src, goldMean, 0, alvision.ReduceTypes.REDUCE_AVG, alvision.MatrixType.CV_32F);
...
//    alvision.Mat actual;
//    alvision.Mat actualMean = goldMean.reshape(0, row_problem_size);
//    alvision.calcCovarMatrix(srcVec, actual, actualMean, singleMatFlags, alvision.MatrixType.CV_32F);
...
//            if ( !isFinite(r0) )
//            {
//                alvision.ASSERT_TRUE(!isFinite(r) != 0);
//            }
//            else if( isNaN(r0) )
//            {
//                alvision.ASSERT_TRUE(isNaN(r) != 0);
//            }
//            else
//            {
//                alvision.ASSERT_TRUE(!isFinite(r) == 0 && isNaN(r) == 0);
//                alvision.ASSERT_LT(Math.abs(r - r0), eps);
//            }
//        }
//    }
//});
