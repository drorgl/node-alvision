...
//class CvTsSimpleSeq {
//    schar* array;
//    public count: alvision.int;
//    public max_count: alvision.int;
//    public elem_size: alvision.int;
//}


//function cvTsCreateSimpleSeq(int max_count, int elem_size ): CvTsSimpleSeq* 
//{
...
//function cvTsReleaseSimpleSeq( CvTsSimpleSeq** seq ) : void
//{
//    cvFree( seq );
//}


//function cvTsSimpleSeqElem( CvTsSimpleSeq* seq, int index ) : schar*  
//{
...
//function cvTsClearSimpleSeq( CvTsSimpleSeq* seq ) : void
//{
//    seq.count = 0;
//}


//function cvTsSimpleSeqShiftAndCopy( CvTsSimpleSeq* seq, int from_idx, int to_idx, void* elem=0 ) : void
//{
...
//function cvTsSimpleSeqInvert( CvTsSimpleSeq* seq ) : void
//{
...
//function  cvTsClearSimpleSet( CvTsSimpleSet* set_header ) : void
//{
//    int elem_size = set_header.elem_size;

//    for(var i = 0; i < set_header.max_count; i++ )
//    {
...
//class  CvTsSimpleGraph
//{
//    public char* matrix;
//    public edge_size: alvision.int;
//    public oriented: alvision.int;
//    public CvTsSimpleSet* vtx;
//} 


//function cvTsClearSimpleGraph( CvTsSimpleGraph* graph ) : void
//{
...
//function cvTsCreateSimpleGraph(max_vtx_count: alvision.int, vtx_size: alvision.int ,
//    edge_size: alvision.int, oriented: alvision.int ): CvTsSimpleGraph*  
//{
...
//function cvTsReleaseSimpleGraph( CvTsSimpleGraph** graph ) : void
//{
//    if( *graph )
//    {
...
//function cvTsSimpleGraphAddVertex( CvTsSimpleGraph* graph, void* vertex ) : alvision.int
//{
//    return cvTsSimpleSetAdd( graph.vtx, vertex );
//}


//function cvTsSimpleGraphRemoveVertex(CvTsSimpleGraph* graph, index: alvision.int) : void
//{
...
//function cvTsSimpleGraphAddEdge(CvTsSimpleGraph* graph, idx1: alvision.int, idx2: alvision.int , void* edge ) : void
//{
...
//function cvTsSimpleGraphRemoveEdge(CvTsSimpleGraph* graph, idx1: alvision.int, idx2: alvision.int ) : void
//{
//    int i, t, n = graph.oriented ? 1 : 2;
...
//function cvTsSimpleGraphFindVertex(CvTsSimpleGraph* graph, index: alvision.int): schar*  
//{
//    return cvTsSimpleSetFind( graph.vtx, index );
//}


//function cvTsSimpleGraphFindEdge(CvTsSimpleGraph* graph, int idx1, int idx2 ): char*  
//{
...
//function cvTsSimpleGraphVertexDegree(CvTsSimpleGraph* graph, index: alvision.int): alvision.int
//{
//    int i, count = 0;
//    int edge_size = graph.edge_size;
//    int max_vtx_count = graph.vtx.max_count;
...
//        super();
//        this.struct_count = 2;
//        this.max_struct_size = 2000;
//        this.min_log_storage_block_size = 7;
//        this.max_log_storage_block_size = 12;
//        this.min_log_elem_size = 0;
//        this.max_log_elem_size = 8;
//        this.generations = 10;
//        this.iterations = this.max_struct_size.valueOf() * 2;
//        this.gen = this.struct_idx = this.iter = -1;
...
//        var sqrt_scale = Math.sqrt(this.ts.get_test_case_count_scale().valueOf());
//        if (code < 0)
//            return code;

//        this.struct_count = cvReadInt(this.find_param(fs, "struct_count"), this.struct_count);
//        this.max_struct_size = cvReadInt(this.find_param(fs, "max_struct_size"), this.max_struct_size);
//        this.generations = cvReadInt(this.find_param(fs, "generations"), this.generations);
//        this.iterations = cvReadInt(this.find_param(fs, "iterations"), this.iterations);
//        this.generations = Math.round(this.generations.valueOf() * sqrt_scale);
//        this.iterations = Math.round(this.iterations.valueOf() * sqrt_scale);

//        this.min_log_storage_block_size = cvReadInt(this.find_param(fs, "min_log_storage_block_size"),
//            this.min_log_storage_block_size);
//        this.max_log_storage_block_size = cvReadInt(this.find_param(fs, "max_log_storage_block_size"),
//            this.max_log_storage_block_size);
//        this.min_log_elem_size = cvReadInt(this.find_param(fs, "min_log_elem_size"), this.min_log_elem_size);
//        this.max_log_elem_size = cvReadInt(this.find_param(fs, "max_log_elem_size"), this.max_log_elem_size);

//        this.struct_count =     alvision.cvtest.clipInt(this.struct_count, 1, 100);
//        this.max_struct_size =  alvision.cvtest.clipInt(this.max_struct_size, 1, 1 << 20);
//        this.generations =      alvision.cvtest.clipInt(this.generations, 1, 100);
//        this.iterations =       alvision.cvtest.clipInt(this.iterations, 100, 1 << 20);

//        this.min_log_storage_block_size = alvision.cvtest.clipInt(this.min_log_storage_block_size, 7, 20);
//        this.max_log_storage_block_size = alvision.cvtest.clipInt(this.max_log_storage_block_size,
//            this.min_log_storage_block_size, 20);

//        this.min_log_elem_size = alvision.cvtest.clipInt(this.min_log_elem_size, 0, 8);
//        this.max_log_elem_size = alvision.cvtest.clipInt(this.max_log_elem_size, this.min_log_elem_size, 10);

//        return 0;
//    }
//    run_func(): void { }
//    set_error_context(condition: char* ,
//        err_msg: char* ,
//        file: char* , line: alvision.int ): void {
//        this.ts.printf(alvision.cvtest.TSConstants.LOG, "file %s, line %d: %s\n(\"%s\" failed).\n"
//               "generation = %d, struct_idx = %d, iter = %d\n",
//            filename, lineno, err_msg, condition, gen, struct_idx, iter);
//        this.ts.set_failed_test_info(alvision.cvtest.FailureCode.FAIL_INVALID_OUTPUT);
//    }
//    test_seq_block_consistence(_struct_idx: alvision.int, seq: CvSeq* , total: alvision.int ): alvision.int {
//        var sum = 0;
...
//            var delta_idx = seq.first.start_index;
...
//        if (this.test_progress < 0) {
//            this.test_progress = 0;
//            this.cpu_freq = alvision.getTickFrequency();
//            this.start_time = alvision.getTickCount();
//        }

//        var t = alvision.getTickCount();
//        this.test_progress = this.update_progress(this.test_progress, 0, 0, (t - this.start_time.valueOf()) / this.cpu_freq.valueOf());
//    }

//    protected struct_count: alvision.int;
//    protected max_struct_size: alvision.int;
//    protected iterations: alvision.int;
//    protected generations: alvision.int;
//    protected min_log_storage_block_size: alvision.int;
//    protected max_log_storage_block_size: alvision.int;
//    protected min_log_elem_size: alvision.int;
//    protected max_log_elem_size: alvision.int;
//    protected gen: alvision.int;
//    protected struct_idx: alvision.int;
//    protected iter: alvision.int;
//    protected test_progress: alvision.int;
//    protected start_time: alvision.int64;
//    protected cpu_freq: alvision.double;
//    protected cxcore_struct: Array<any>;
//    protected simple_struct: Array<any>;
//    protected storage: CvMemStorage;
//}
...
//{
//    clear(): void {
//        for (var i = 0; i < this.simple_struct.length; i++ )
...
//    test_multi_create(): alvision.int {
//        var writer = new Array<CvSeqWriter> (this.struct_count);
//        var pos = new Array<alvision.int> (this.struct_count);
//        var index = new Array<alvision.int> (this.struct_count);
//        int  cur_count, elem_size;
//        var rng = this.ts.get_rng();

//        for (var i = 0; i < this.struct_count; i++ )
//        {
//            //double t;
//            CvTsSimpleSeq * sseq;
...
//            var t = alvision.cvtest.randReal(rng).valueOf() * (this.max_log_elem_size.valueOf() - this.min_log_elem_size.valueOf()) + this.min_log_elem_size.valueOf();
//            elem_size = Math.round(Math.exp(t * Math.LOG2E));
...
//        return 0;
//    }
//    test_get_seq_elem(_struct_idx: alvision.int, iters: alvision.int): alvision.int {
//        var rng = this.ts.get_rng();
...
//        return 0;
//    }
//    test_get_seq_reading(_struct_idx: alvision.int, iters: alvision.int): alvision.int {
//        const max_val = 3 * 5 + 2;
//        CvSeq * seq = (CvSeq *)cxcore_struct[_struct_idx];
//        CvTsSimpleSeq * sseq = (CvTsSimpleSeq *)simple_struct[_struct_idx];
//        int total = seq.total;
...
//            var op = alvision.cvtest.randInt(rng) % max_val;
...
//        return 0;
//    }
//    test_seq_ops(iters: alvision.int): alvision.int {
//        const int max_op = 14;
//        int max_elem_size = 0;
//        schar * elem2 = 0;
//        var rng = this.ts.get_rng();
...
//                    elem_mat = Mat(1, elem_size, alvision.MatrixType.CV_8U, elem);
//                    alvision.cvtest.randUni(rng, elem_mat, alvision.Scalar.all(0), alvision.Scalar.all(255));
...
//                    elem_mat = Mat(1, MAX(count, 1) * elem_size, alvision.MatrixType.CV_8U, elem);
//                    alvision.cvtest.randUni(rng, elem_mat, alvision.Scalar.all(0), alvision.Scalar.all(255));
...
//                    //console.log(util.format("%d. %d. %d-th size = %d\n", gen, iter, i, sseq.count );
...
//function icvCmpSeqElems( const void* a, const void* b, void* userdata ) : alvision.int
//{
//    return memcmp( a, b, ((CvSeq*)userdata).elem_size );
//}

//var icvCmpSeqElems2_elem_size = 0;
//function icvCmpSeqElems2( const void* a, const void* b ) : alvision.int
//{
...
//{
//    clear(): void {
//        for (var i = 0; i < simple_struct.size(); i++ )
...
//            elem_mat = Mat(1, cvset.elem_size, alvision.MatrixType.CV_8U, &elem_buf[0]);
//            alvision.cvtest.randUni(rng, elem_mat, alvision.Scalar.all(0), alvision.Scalar.all(255));
...
//            if (pure_vtx_size) {
//                elem_mat = Mat(1, graph.elem_size, alvision.MatrixType.CV_8U, &elem_buf[0]);
//                alvision.cvtest.randUni(rng, elem_mat, alvision.Scalar.all(0), alvision.Scalar.all(255));
//            }
...
//            if (pure_edge_size > 0) {
//                elem_mat = Mat(1, graph.edges.elem_size, alvision.MatrixType.CV_8U, &elem_buf[0]);
//                alvision.cvtest.randUni(rng, elem_mat, alvision.Scalar.all(0), alvision.Scalar.all(255));
//            }
...
//    //int test_seq_block_consistence( int struct_idx );
//    create_random_graph(_struct_idx :alvision.int) : alvision.int{
//    var rng = this.ts.get_rng();
//    var is_oriented = alvision.cvtest.randInt(rng).valueOf() % 2;
//    //int i,
//        var vtx_count = alvision.cvtest.randInt(rng).valueOf() % this.max_struct_size;
//    var edge_count = alvision.cvtest.randInt(rng).valueOf() % Math.max(vtx_count * 20, 1);
//    CvGraph * graph;
...
//alvision.cvtest.TEST('Core_DS_Seq', 'basic_operations', () => { Core_SeqBaseTest test; test.safe_run(); });
//alvision.cvtest.TEST('Core_DS_Seq', 'sort_invert', () => { Core_SeqSortInvTest test; test.safe_run(); });
//alvision.cvtest.TEST('Core_DS_Set', 'basic_operations', () => { Core_SetTest test; test.safe_run(); });
//alvision.cvtest.TEST('Core_DS_Graph', 'basic_operations', () => { Core_GraphTest test; test.safe_run(); });
//alvision.cvtest.TEST('Core_DS_Graph', 'scan', () => { Core_GraphScanTest test; test.safe_run(); });
