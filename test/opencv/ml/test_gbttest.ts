//LEGACY, should not be implemented
...
//        var code: alvision.cvtest.FailureCode | alvision.int= alvision.cvtest.FailureCode.OK;
...
//            if (Math.abs(*it1 - *it2) > FLT_EPSILON) {
