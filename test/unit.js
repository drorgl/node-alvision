...
//add async test
async.awhilst = function (test, iterator, callback) {
    test(function (cbval) {
        if (cbval) {
            iterator(function (err) {
                ...
                async.awhilst(test, iterator, callback);
            });
        }
        else {
            callback();
...
test("ffmpeg", function (ffm) {
    ...
    ffm.test("Testing Input", function (t) {
        ...
        t.doesNotThrow(function () {
            alvision.ffmpeg.OpenAsInput(input_file, null, null, function (err, ffm) {
                ffm.Close();
            });
        }, "opening input file without format specified");

        t.doesNotThrow(function () {
            alvision.ffmpeg.OpenAsInput(input_file, "mp4", null, function (err, ffm) {
                t.ok(ffm.GetStreams, "Has GetStreams function");
                t.doesNotThrow(function () { ffm.GetStreams() }, undefined, "Invoked GetStreams()");
