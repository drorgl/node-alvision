...
//const output_file = path.join(__dirname, 'HelenFisher_2008.mkv')

//import * as alvision from "../tsbinding/alvision";


////add async test
// function awhilst  (test, iterator, callback) {
//	test(function (cbval) {
//		if (cbval) {
...
//					return callback(err);
//				}
//				awhilst(test, iterator, callback);
//			});
//		}
//		else {
//			callback();
...
//		});
//	});
//	ffm.test("List Output Formats", function (t) {
//		t.ok(alvision.ffmpeg.ListOutputFormats, "ListOutputFormats exists on ffmpeg");

//		alvision.ffmpeg.ListOutputFormats(function (err, list) {
//			t.ok(err == null, "error is null (got: " + err + ")");
...
//	ffm.test("List Codecs", function (t) {
//		t.ok(alvision.ffmpeg.ListCodecs, "ListCodecs exists on ffmpeg");

//		t.doesNotThrow(function () {
//			alvision.ffmpeg.ListCodecs(function (err, list) {
//				t.doesNotThrow(function () {
//					t.ok(err == null, "error is null (got: " + err + ")");
...
//		t.doesNotThrow(function () {
//			alvision.ffmpeg.ListDevices(function (err, list) {
//				t.doesNotThrow(function () {
//					t.ok(err == null, "error is null (got: " + err + ")");
...
//	ffm.test("List Filters", function (t) {
//		t.ok(alvision.ffmpeg.ListFilters, "ListFilters exists on ffmpeg");

//		t.doesNotThrow(function () {
//			alvision.ffmpeg.ListFilters(function (err, list) {
//				t.doesNotThrow(function () {
//					t.ok(err == null, "error is null (got: " + err + ")");
...
//	ffm.test("Testing Output", function (t) {
...
//			alvision.ffmpeg.OpenAsOutput(output_file, "mkv", null,  (err, ffmo) =>{
//				t.doesNotThrow(()=>{
//				alvision.ffmpeg.OpenAsInput(input_file, "mp4", null,  (err, ffmi) =>{
//					let istreams = ffmi.GetStreams();

//					let istreamdict = {}; istreams.forEach( (item, idx)=> { istreamdict[item.id] = item });

//					let matchingMatrix = {};
//					let matchingStreams = {};

//					for (let i = 0; i < istreams.length; i++) {
//						let istream = istreams[i];
...
//					var ostreamdict = {}; ostreams.forEach((item, idx) =>{ ostreamdict[item.id] = item });
...
//		t.doesNotThrow( () =>{
//			alvision.ffmpeg.OpenAsOutputBuffer(null,"ffm", 1024, 1024 * 1024, null, (err, ffmo)=> {
//				t.throws(function () { 
//					ffmo.AddStream({ "id": "0" /*, "mediatype": alvision.mediatype.audio*/, "channels": 2, "channelslayout": "stereo", "samplefmt": "fltp", "samplerate": 44100, /*"framerate": null,*/ "codec": "aac", "timebase": 0.000022675736961451248, "bitrate": 94997 /*, "streamindex": 0*/ });
//				}, "experimental stream");
//				t.doesNotThrow(function () {
//					ffmo.Close();
//				}, "Close");
