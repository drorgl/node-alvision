...

{
  ...
  "targets": [{
      ...
      , "sources": [
		...
		, "src/opencv/video/tracking/KalmanFilter.cc"
		, "src/opencv/video/tracking/KalmanFilter.h"
		, "src/opencv/video/tracking/DualTVL1OpticalFlow.cc"
		, "src/opencv/video/tracking/DualTVL1OpticalFlow.h"
		, "src/opencv/video/tracking/DenseOpticalFlow.h"
		, "src/opencv/video/tracking/DenseOpticalFlow.cc"
		, "src/opencv/video/tracking.h"
		, "src/opencv/video/tracking.cc"
		...
		, "src/utilities/threadsafe_unordered_map.h"
		, "src/utilities/atomic_lock_guard.h"
		, "src/utilities/atomic_lock_guard.cc"
